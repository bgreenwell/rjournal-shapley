...
KernelSHAP, or at least it's implementation in \pkg{shap}, distributes the number of replications unevenly across the different features. Apparently, features with higher variance are attributed more replications. 
...
Several equivalent formulas for the Shapley value (Equation \eqref{eqn:shapley-value}). Both \citet{lundberg-2017-KernelSHAP}...

Discuss Shapley values as the solution to a weighted least squares problem; see \citet{charnes-1988-extremal} for details.
